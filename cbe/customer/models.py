...
class Customer(PartyRole):
    ...
    customer_status = models.CharField(
        max_length=100, choices=customer_status_choices)
...
class CustomerAccount(models.Model):
    ...
    customer_account_contact = models.ManyToManyField(
        CustomerAccountContact, blank=True)
...
class CustomerAccountRelationship(models.Model):
    ...
    from_account = models.ForeignKey(
        CustomerAccount, related_name='related_from_account')
    to_account = models.ForeignKey(
        CustomerAccount, related_name='related_to_account')
