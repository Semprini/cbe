...
from cbe.location.models import UrbanPropertyAddress, Country, City, PoBoxAddress, import_countries
...
class LocationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.city = City.objects.create(
            code="AKL", name="Auckland", country=self.country)
        self.address = UrbanPropertyAddress.objects.create(
            street_number_first=1, street_name='Credibility', street_type='Street', locality='Auckland Central', postcode='1022', city=self.city)
        self.po = PoBoxAddress.objects.create(
            box_number="123", locality="Space")
    ...
    def test_names(self):
        ...
        self.assertEqual(
            "{}".format(self.address), '1 Credibility Street, Auckland Central, Auckland')
