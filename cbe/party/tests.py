...
class PartyTests(TestCase):
    ...
    def setUp(self):
        self.individual = Individual.objects.create(
            given_names="John", family_names="Doe", form_of_address='Mr', middle_names='Hubert')
        ...
        self.role = GenericPartyRole.objects.create(
            party=self.organisation, name="Generic")
    ...
    def test_role_asignment(self):
        ...
        self.assertEqual(
            '{}'.format(self.role.party), '{}'.format(self.role.individual))
        self.role.organisation = self.organisation
        self.assertEqual(
            '{}'.format(self.role.party), '{}'.format(self.role.organisation))
...
class PartyAdminTests(TestCase):
    ...
    def test_genericpartyrole_form(self):
        ...
        self.assertEqual(mf.base_fields['party'].choices[
                         1], ('1::Individual::Mr John Hubert Doe', 'Mr John Hubert Doe'))

        mf.cleaned_data = {
            'party': "1::Individual::Mr John Hubert Doe,Mr John Hubert Doe", }
...
class PartyAPITests(APITestCase):
    ...
    def test_get_individual(self):
        ...
        request = self.factory.get(
            '/party/individual/{}/'.format(self.individual.id),)
    ...
    def test_create_individual(self):
        ...
        data = {'given_names': 'test first', 'family_names': 'test_last', 'name':'foo'}
    ...
    def test_putnpatch_individual(self):
        ...
        data = {'given_names': 'test John', 'family_names': 'Doe', 'name':'foo'}
