...
class BusinessInteractionTests(TestCase):
    ...
    def setUp(self):
        self.interaction = BusinessInteraction.objects.create(
            description="Test")
        self.item = BusinessInteractionItem.objects.create(
            business_interaction=self.interaction, action="Test Item")
        self.role = BusinessInteractionRole.objects.create(
            business_interaction=self.interaction, name="Test Role")
